...
class App extends Component {
  ...
  generateCompanyTags = function (companies) {
    let companiesTags = companies.map((c) => (
  ...
  render() {
    ...
    let hottestItem = this.state.store.filter((i) => i.hottest === true);
      ...
      <div>
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-1">
            {companies.map((c, key) => (
              <Company key={key} name={c.name} revenue={c.revenue} />
            ))}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-2">
            <Landing user={this.state.user} hottestItem={hottestItem[0]} />
